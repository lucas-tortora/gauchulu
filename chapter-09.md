...
|---|---|---|---|
| 1 | **North — the Antiquarian** (or **Marta**, if she's covering him mid-panel-draw) | **CON Normal** for him; **automatic** if it lands on Marta — see row 8 | He's a PC — his player rolls it, not fragile-body rules |
...
| 8 | **West — Héctor** · **Silvio** · **Marta** (wherever she's standing) | **automatic — no roll** | ⚑ **Wrong Returned hold by default.** Their partial alignment *is* the qualification; the geometry has no leverage on people it already changed. Say so out loud — the table should notice the ones who don't flinch |
...
> **If a fragile NPC fails here**, they break mid-audit — and unlike Phase 1, the ring is 80% closed and there is nowhere for the pressure to go but through the hole they leave. Vacated-node rule applies immediately ([C8](chapter-08.md#opening-situation)): one round to fill it or the phase restarts. **Marta is the designated floater again** — she's already covering North for the Antiquarian's panel-draws, and the same alignment that lets her do that lets her step to any other broken position if North doesn't need her that round. If she's tied up at North when something else breaks, fall back on the [ring clock](chapter-08.md#the-ring-clock--who-braces-whom) for the nearest neighbor: Silvio or Edelmiro cover each other, Luisa can be reached from East or North, Tomás from East or Saúl's side.
>
...
3. **Marta, Héctor, or Silvio steps toward the center** (only if the players built genuine rapport with the Wrong Returned — whichever of the three the party is closest to, and whichever isn't needed elsewhere that round): they co-anchor from the outer ring by extending their partial geometric alignment to hold the center steady from outside. **Their choice; the investigators cannot make it for them.** Whoever does it leaves their own position/duty uncovered for the phase — West, clock-8, or the Antiquarian's North cover, respectively — a real cost even though Wrong Returned normally hold automatically. If they do it, Phase Five has near-certain success. Cost: see below.

> **What happened at this table.** Don Eusebio held. Benancio did not — he took the geometry's full pressure in the three-round climax and did not step back from it; the seal took him along with the last of the working. **Death was on the table as the player's own dramatic choice, never the default** — this table's default would have been survival, same as every other position tonight — but this is the choice that got made, and the seal is what it cost. With the center's co-anchor gone mid-phase, **Tránsito left South** and stepped in beside Eusebio to finish it — the Round-1 "step in to co-anchor" option, taken from the outer ring instead of the center. That is what closed the pit. South stood open for the rest of the phase; nothing came through it before the seal landed.
>
> **Eusebio survives**, per the default above. Benancio's death is permanent — but the campaign doesn't lose its second Mark: **Negro Camba was marked in the same crisis**, holding East through what the Hound did to that line — and his obsidian machete didn't survive it either, chipped to nothing on the same exchange. **Tránsito and Negro Camba both leave C9 alive and Marked** — see `flowmap.md` (the Marks thread). *(Tránsito did not make it to Arc 4 — she died on the road in C10; by [C12](chapter-12.md#option-3--destroyed) Negro Camba is the table's one remaining Mark. That's a C10 event, not a correction to what happened here.)*
...
> | **2** | The revelation — offers the anchor *quiet* | One round to decide; a co-anchor's hands answer it wordlessly | **Co-anchor now** if not already · **speak to them by name** (a human voice from a known position is worth as much as a roll — let it matter) |
> | **3** | Countermovement stops — no room left | Holds. The Antiquarian draws the last line | Everyone on the chant — _Antu kishu, lan amukey_ · **obsidian is useless here** and Negro Camba should feel that · **Negro Camba and Tránsito feel their contract ride on whether this line closes** — no action available, just the wait |
...
> **The contract rides on this line.** As **the Antiquarian** kneels to draw the last line, **Negro Camba and Tránsito** feel the old contract sit up — the wound that closed, the strength that came from nowhere, both leaning toward the pit like the candle flames once leaned toward Quirce's mouth. The price was always *"su sangre, para asegurar que la cicatriz se cierre"* — the scar closing **is** the payment, not a gesture either of them can make. There is nothing to offer here, no palm to press, no roll to attempt. The goat is already looking at them. **If the line closes and the seal holds, the debt is paid — automatically, in full.** **If it doesn't**, Mandinga collects with their lives: run [the alternate outcome's](#if-it-doesnt-seal--the-alternate-outcome) consequence for each of them. He does not renegotiate.
...
- **Casualties land on the exposed, not everyone.** Use the same logic as [the malón cull](#the-malón-strikes) and the [fragile-bodies rule](chapter-08.md#opening-situation): whoever is still holding a compromised position when it comes apart is at risk — Luisa, Tomás, a guard, possibly Silvio or Edelmiro if they've already taken damage tonight. **Most PCs are not defaulted to death** — Marked, mad, gravely wounded, or (rarely, dramatically) dead is the ladder, same as C3, and the [replacement PCs](chapter-07.md#reemplazos--pjs-para-entregar-si-un-pj-muere-o-enloquece) are already standing by if needed. **Negro Camba and Tránsito are the one exception** — see below.
- **Mandinga collects Negro Camba and Tránsito outright.** Their deal was never a blood offering the players could make mid-ritual — it was always the scar closing or their lives, full stop. On a failed seal, **both** die, on-screen, immediately, the same way: run it as [Mengua/Shrivelling](assets/mandinga-sequence.md) cast **four times on each of them**, once per limb. For Negro Camba it's his old wound becoming the door Mandinga tears him open through; for Tránsito it's her power leaving her body the same violent way it arrived. Mandinga does not leave an empty vessel standing. This is not softened by anything else going right in the phase — it fires whenever the seal itself fails, independent of the rest of this outcome. The [replacement PCs](chapter-07.md#reemplazos--pjs-para-entregar-si-un-pj-muere-o-enloquece) cover this too.
...
| **Héctor / Silvio / Marta** | One of the three surviving matters for leading the C12 cordon panel-placement; losing all three makes C12 harder, not impossible — a Warding-PC can substitute |
...
**The center anchor**: Don Eusebio survives. **Benancio does not** — he held through the press and the geometry closed over him with the rest of the working; there is no body distinct from what the seal became, and everyone in the ring knows it happened because they felt the moment the pressure at center changed hands. Eusebio looks at his own hands — _"Puedo sentir dónde están los ángulos, pero ya no los escucho… como la diferencia entre saber dónde está un cuarto y estar dentro."_ Recovery costs months; nightmares in which the geometry is the dreaming landscape; never comfortable in rooms with precise right angles again — and now also the specific weight of who was standing next to him. **Tránsito**, who left South to close what Benancio couldn't finish, takes the co-anchor's cost in his place: SAN and a CON check, on top of the Mandinga deal she already carries. She is the reason the seal completed at all.

**Héctor, Silvio, and Marta** _(all three present this table)_: the Wrong Returned feel the closing first. As the seal completes, whichever of them didn't co-anchor flinches — the first genuine physical reaction in months — then **laughs**, involuntary, a sound from below calculation. The nearest of the others takes their hand. _"Está quieto"_, dice uno. _"Sí"_, dice otro. They are not instantly restored; the alignment fades over weeks like dye washing out. They will always be different, but the pull, the sound in the angles, the wrong shadow — those go. _"Creo que voy a poder dormir de nuevo. Eventualmente."_ **If one of them co-anchored** ([Phase 5, option 3](#phase-five--the-final-seal)): the fade burns off all at once for that one — they spend the night unable to speak or move, not from trauma but from becoming abruptly, entirely themselves; by morning they are present, quiet, and hungry for the first time in fourteen months. The other two are steadier by comparison, having only carried the ordinary weight of the night.
...
**Quirce**: gone. He broke and ran before the seal completed — no debt-line, no notebook handed over, no oblique offer. Whatever he saw of Benancio's death is his alone; he isn't there to be asked. The tarnished copper he spent C6–C8 wiring into the geometry stays behind — **the party recovers it after the seal, not him** — so he leaves without the one thing his network would have wanted most. Read his absence as consistent with everything else on file about him (`assets/npc-stats.md`: _"not brave... will flee before fighting"_), not as a mystery to solve. He resurfaces off-stage in Arc 4 exactly as written — the half-burned letter in Lacasa's office ([C11](chapter-11.md#tracing-saráchagas-last-hours)), his own letter to Mercedes ([C12](chapter-12.md#the-day-before-the-night)) — but the party's read on him going into those scenes is now colored by a man who ran the one night it mattered most. Play that coldness as available, not mandatory.
...
This sets him up as a possible Arc 4 outer-ring participant in [C12](chapter-12.md#chapter-12--el-libro). If the table would rather not bring him: the players talk him out of it, or the authorities reach him first. The line is offered; using it is the table's choice.
...
He rides out alone. The next time the players see him is [C11](chapter-11.md#chapter-11--la-decisión). Off-screen between now and then, he kills at least four of the twelve priests, loses a fight against three more, and rides east on a stolen horse.
...
- [x] **Ran this table**: Eusebio survives; **Benancio dies holding the seal**; **Tránsito co-anchors from South to close it**; **Negro Camba is newly Marked in the crisis**. Don Eusebio's *"What do I owe?"* now carries Benancio's name too.
...
- [ ] Mandinga-deal PCs (Negro Camba, Tránsito): **no offering mechanic** — the debt is paid automatically if the seal completes, nothing to roll or decide. **If the seal fails**: both die on-screen, **Shrivelling ×4 each** (limb from limb). See [the alternate outcome](#if-it-doesnt-seal--the-alternate-outcome).
