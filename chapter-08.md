...
|**Eastern position**|**Negro Camba** — carries an **obsidian knife and machete**, effective against non-corporeal beings (may hand one off to another PC or NPC). Also one of the **two Mandinga deal-PCs** — his blood is owed at this position or at the Phase 5 seal. Becomes the line, does not act outward — the side that fails first|
...
|**Southern ring**|**Tránsito** (Marked, Mandinga deal) — the other deal-PC; same blood-debt terms as Negro Camba, but owed at her own position or the seal|
...
> **The Mandinga deals come due tonight.** The two deal-PCs — **Negro Camba (east)** and **Tránsito (south)** — traded, respectively, **health** and **power** — and the price both accepted was *"offering their blood to ensure the scar is closed."* Tonight is the closing; the debt is literal. **The offering**: an opened palm pressed to the panel line at their position — a pure decision, no roll. **When**: usable early at the [Phase-2 eastern tear](#the-eastern-incursion) (blood on the seam counts as the **bracing second hand** for that round — CON drops from Hard to Normal for the easterner, which is convenient since Negro Camba is holding that exact position); **owed at the [Phase-5 seal](chapter-09.md#phase-five--the-final-seal) at the latest** — as the last line is drawn, each of them feels the old contract sit up, and the goat is already looking at them. **Withheld**: the health-PC's closed wound begins to reopen at the seal (1 HP/day, visible, until the debt is paid another way); the power-PC's gift inverts — penalty die on its uses — until amends. Mandinga does not renegotiate; he collects. ([The deal](assets/mandinga-sequence.md).)
...
| 21 | Phase 5 R3 | Deal-PCs | **none — pure decision** | Palm to the panel line |
...
|---|---|---|---|
| **1** | The panel seam thins with that sustained-note quality, then tears — two handspans wide. Cold comes through it, and the smell of the pit | **CON Hard** — Normal if a second person braces them (hand on shoulder), or if a **deal-PC opens a palm on the seam** (blood counts as the bracing hand) | **1D4 SAN**, 3 min off the clock, wedge widens |
