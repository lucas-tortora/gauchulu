...
> **The Mandinga deals are life-or-death tonight — not a blood offering.** The two deal-PCs — **Negro Camba (east)** and **Tránsito (south)** — traded, respectively, **health** and **power**, and the price was never a token gesture: *"su sangre, para asegurar que la cicatriz se cierre"* means the scar closing **is** the payment. **There is no palm-to-the-panel offering to make mid-ritual** — nothing either of them does individually settles the debt early, at the eastern tear or anywhere else. **If the seal completes** ([Phase 5](chapter-09.md#phase-five--the-final-seal)): the debt is paid in full, automatically, by the closing itself — no roll, no action, just a relief they'll feel in their bodies the instant it seals. **If it doesn't** — dawn arrives unsealed, the ring truly comes apart, see [the alternate outcome](chapter-09.md#if-it-doesnt-seal--the-alternate-outcome) — **Mandinga collects, and he collects with their lives.** Negro Camba's closed wound doesn't just reopen: it's the door Mandinga tears him open through, limb from limb — run it as [Mengua/Shrivelling](assets/mandinga-sequence.md) cast **four times**, once per limb, an execution, not a debuff. Tránsito's power is simply taken back — it leaves her the way it arrived, and Mandinga does not leave an empty vessel standing. He does not renegotiate. ([The deal](assets/mandinga-sequence.md).)
